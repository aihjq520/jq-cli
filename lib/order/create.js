...
const create = (name) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const branch = yield (0, create_1.getBranch)();
    ...
    (0, create_1.changeDeployInfo)(name, k8sInfo);
    // initProject()
});
const downloadTemplate = (branch) => __awaiter(void 0, void 0, void 0, function* () {
    // log.info("开始下载模板");
    //git模块的地址
    const dlSpinner = (0, ora_1.default)(chalk.cyan('Downloading template...'));
    try {
        dlSpinner.start();
        (0, child_process_1.execSync)(`git clone -b ${branch} git@newgitlab.com:pro-frontend/base-template.git`, { cwd: process.cwd(), // path to where you want to save the file
        });
    }
    catch (err) {
