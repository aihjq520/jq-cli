...
exports.getK8SInfo = exports.changeCiConfigInfo = exports.changePackageInfo = void 0;
...
function changeCiConfigInfo(name, info) {
    ...
    content = content.replace(/_projectName/g, name);
    const { port, namespace } = info;
    content = content.replace(/_namespace/g, namespace);
    content = content.replace(/_portDev/g, port);
    content = content.replace(/_portTest/g, (Number(port) + 1).toString());
